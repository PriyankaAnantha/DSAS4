...
// navigate to the respective directory in powershell using the command Set-Location 
// gcc -o doubly_linked_list DoublyLinkedList.c
//./doubly_linked_list
// clear-host
//
